...
import x.ministart.parse.ParsePhraseLettersWorker;
import x.ministart.parse.ParseVerbe1;
import x.ministart.parse.ParseVerbe2;
import x.ministart.parse.ParseAllVerbe;
			...
			item.addActionListener (new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					new ParseParagWorker(ui);
                        ...
                        menu.add (item = new JMenuItem ("Parse Phrase"));
			item.addActionListener (new ActionListener() {
				@Override
				public void actionPerformed(ActionEvent e) {
					new ParsePhraseLettersWorker(ui);
				}

			});
                         menu.add (item = new JMenuItem ("Parse Verbe 1ére G"));
			item.addActionListener (new ActionListener() {
				@Override
				public void actionPerformed(ActionEvent e) {
					new ParseVerbe1(ui);
                        ...
                        menu.add (item = new JMenuItem ("Parse Verbe 2éme G"));
			item.addActionListener (new ActionListener() {
				@Override
				public void actionPerformed(ActionEvent e) {
					new ParseVerbe2(ui);
                        ...
                        menu.add (item = new JMenuItem ("Parse ALL Verbe "));
			item.addActionListener (new ActionListener() {
				@Override
				public void actionPerformed(ActionEvent e) {
					new ParseAllVerbe(ui);
				}
